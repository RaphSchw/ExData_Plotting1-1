...
png(filename = "./figure/plot1.png", width = flngth, height = flngth) ##define the file name and activate the png graphics device
hist(as.numeric(test$Global_active_power), 
